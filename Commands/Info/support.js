...
module.exports = {
  ...
  guildOnly: true,
  group: 'Info',
  description: 'Displays various ways to show support for Alina',
  ...
  run: async (client, message) => {
    ...
    return message.channel.send(
      new MessageEmbed()
      .setColor(color)
      .setTitle('Support Alina and its Development!')
      .setDescription([
        'Alina is an open-source, but still a young and adolescent bot, not yet fully matured.',
        ...
        'It is good to hear that you\'re interested in supporting Alina, and there',
      ...
      .addFields([
        {
          ...
          value: [
            ...
            'other people and participate in Alina\'s support server from development to production,',
            'test bots, report bugs, or add feature requests, and be updated on what\'s to come.'
          ].join(' ')
        },{
          name: 'Contribute to Repository.',
          value: [
            'Found some bugs? Do you feel you can fix it yourself? Contribute to Alina\'s repository',
            '[here](https://github.com/brblacky/Alina) by creating an issue or making a reasonable',
          ...
          value: [
            ...
            'may [join](https://discord.gg/uAVaeCP9VH) my support server and contact `Blacky#6618, Venom#9718` from there.'
          ].join(' ')
        },{
          name: 'Vote Alina.',
          value: [
      ...
      ]).setFooter(`Support | \©️${new Date().getFullYear()} Alina`)
    )
  }
}
